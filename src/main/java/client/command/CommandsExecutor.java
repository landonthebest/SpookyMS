...
import client.command.commands.gm0.AutoPickupCommand;
import client.command.commands.gm0.BlackjackCommand;
...
import client.command.commands.gm0.ItemEditCommand;
import client.command.commands.gm0.OnlineCommand;
import client.command.commands.gm0.SellAllCommand;

import client.command.commands.gm0.SlayerCommand;
...
import client.command.commands.gm0.WipeEquipCommand;
...
public class CommandsExecutor {
    ...
    private void registerLv0Commands() {
        ...
        addCommand("itemedit", ItemEditCommand.class);
        addCommand("WipeEquip", WipeEquipCommand.class);
        addCommand("autopickup", AutoPickupCommand.class);
        addCommand("bj", BlackjackCommand.class);
        addCommand("search", SearchCommand.class);
        addCommand("slayer", SlayerCommand.class);
